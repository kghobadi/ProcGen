...
public class CornPrint : MonoBehaviour {
	...
	void Start () {
        ...
        for (int y = 0; y < 10; y++) //rows
        {
            for (int x = 0; x < 10; x++) // columns
            {
                ...
                {
                    Instantiate(corn1, new Vector3(x * 30f, 0f, y * 30f), Quaternion.Euler(0f, 0f, 0f));
                }
                else //50% chance of happening
                {
                    Instantiate(corn2, new Vector3(x * 30f, 0f, y * 30f), Quaternion.Euler(0f, 0f, 0f));
                }
            }
        }
